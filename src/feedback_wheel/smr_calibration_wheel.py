...
class SmrCalibrationWheel(object):
    def __init__(self):
    ...
    def run(self):
        ...
        for i,idx in enumerate(sequence):
            ...
            while t < Period:
                ...
                if idx:
                   value = math.sin(2.0*math.pi*t*F)/2 + 0.5
                else:
                    value = - math.sin(2.0*math.pi*t*F)/2 + 0.5 
                value = normalize_probabilities_wheel_bar(value, 1, -1, 1, 0)
            ...
            ##### Boom #####
            gui.set_color_wheel_bar(self.colors[idx])
