...
class Fixation:
	def __init__(self,window):
		...
		self.size = numpy.int32(window.height/12)
		# vertical line coordinates
		self.vertical_start = (center[0], center[1]-self.size)
		self.vertical_stop = (center[0], center[1]+self.size)
		# horizontal line coordinates
		self.horizontal_start = (center[0]-self.size, center[1])
		self.horizontal_stop = (center[0]+self.size, center[1])
